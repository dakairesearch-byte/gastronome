  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 flex items-center justify-center px-4">
      <div className="max-w-md text-center space-y-8">
        ...
        {/* Illustration */}
        <div className="bg-white rounded-xl p-8 border border-amber-100 shadow-sm">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          <Link
            href="/"
            className="px-6 py-3 bg-amber-500 text-white rounded-xl hover:bg-amber-600 transition-colors font-semibold text-center"
          >
            Go Home
          </Link>
          <Link
            href="/restaurants"
            className="px-6 py-3 border-2 border-amber-500 text-amber-600 rounded-xl hover:bg-amber-50 transition-colors font-semibold text-center"
          >
            Explore Restaurants
          </Link>
        </div>
