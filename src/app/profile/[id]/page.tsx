            ...
            <div className="md:col-span-1 space-y-3">
              {isOwnProfile ? (
                <>
                  <Link
                    href="/profile/edit"
                    className="w-full py-3 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors font-semibold text-center flex items-center justify-center gap-2"
                  >
                    <Edit2 size={18} />
                    Edit Profile
                  </Link>
                  <Link
                    href="/review/new"
                    className="w-full py-3 border-2 border-amber-500 text-amber-600 rounded-lg hover:bg-amber-50 transition-colors font-semibold text-center"
                  >
                    Write Review
                  </Link>
                </>
                ...
                <>
                  ...
                  {profile.email && (
                    <a
                      ...
                      className="w-full py-3 border-2 border-amber-500 text-amber-600 rounded-lg hover:bg-amber-50 transition-colors font-semibold text-center flex items-center justify-center gap-2"
                    >
                      <Mail size={18} />
                      Contact
                    </a>
