...
export default function CriticCard({
  ...
  return (
    <Link href={`/profile/${profile.id}`}>
      <div
        className={`rounded-2xl border transition-all duration-300 cursor-pointer group hover:-translate-y-1 ${
          isFeatured
            ? 'bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200/60 shadow-md hover:shadow-xl'
            : 'bg-white border-gray-100/80 shadow-sm hover:shadow-xl hover:border-amber-200/60'
        }`}
      >
