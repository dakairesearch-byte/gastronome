...
export default function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    <Link href={`/restaurants/${restaurant.id}`}>
      <div className="bg-white rounded-xl shadow-sm hover:shadow-lg border border-gray-100 cursor-pointer transition-all duration-300 group overflow-hidden hover:-translate-y-1">
        <div className="p-5 space-y-4">
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <span className="text-base font-bold text-emerald-600 font-mono whitespace-nowrap">
              {priceDisplay}
            </span>
          </div>
